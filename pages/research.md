---
title: Research
description: Evolutionary genetics, ecology, and molecular evolution in natural populations.
background: /assets/banners/research.jpg
...
Components of this work are in collaboration with [Howard Rundle](http://www.science.uottawa.ca/~hrund050/) at the University of Ottawa and [John Jaenike](http://www.rochester.edu/College/BIO/professors/jaenike.html) at the University of Rochester.

![]({{ '/assets/photos-general/map.jpg' | relative_url }} "Geographic range of D. recens and D. subquinaria")
...
This work is in collaboration with [Clare Scott Chialvo](https://sites.google.com/appstate.edu/scott-chialvo-lab) at Appalachian State, [Laura Reed](http://flygxe.ua.edu/) at the University of Alabama, and [Thomas Werner](http://www.bio.mtu.edu/wernerlab/index.html) at Michigan Technological University.

![]({{ '/assets/photos-general/phalloides.jpg' | relative_url }} "Amanita phalloides, a very toxic mushroom")
![]({{ '/assets/photos-general/skunk.jpg' | relative_url }} "Skunk cabbage, [photo from Biopix]")
...
Components of this work are in collaboration with [Rob Unckless](https://unckless.wordpress.com/) at the University of Kansas.

![]({{ '/assets/photos-general/daughters.jpg' | relative_url }} "Males with >90% daughters carry a driving X chromoosme")
![]({{ '/assets/photos-general/drive_phylogeny.jpg' | relative_url }} "In D. recens, the X-drive haplotype is derived from wild-type")
...
![]({{ '/assets/photos-general/CI.jpg' | relative_url }} "Cytoplasmic incompatibility phenotype ad dynamics")
